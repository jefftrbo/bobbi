...
function App() {
   ...
   * Professional 2-color alternating scheme
   */
  const getAvatarColor = (name) => {
    const colors = [
      'linear-gradient(135deg, #3b82f6 0%, #2563eb 100%)', // Professional blue
      'linear-gradient(135deg, #64748b 0%, #475569 100%)', // Professional slate gray
    ];
